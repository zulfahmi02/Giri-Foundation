...
class DonationCampaignPolicy
{
    ...
    public function forceDelete(User $user, DonationCampaign $donationCampaign): bool
    {
        return false;
    }
    ...
    public function replicate(User $user, DonationCampaign $donationCampaign): bool
    {
        return false;
    }

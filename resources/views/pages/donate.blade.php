...
@section('content')
    ...
    <section class="mx-auto max-w-7xl px-6 pt-8 pb-16 lg:px-10 lg:pt-10 lg:pb-20">
        <div class="grid gap-8 lg:grid-cols-12 lg:items-start">
            ...
            <div class="lg:col-span-7">
                <div class="surface-card rounded-[2rem] p-6 sm:p-8 lg:p-10">
                    @if ($errors->any())
                    ...
                    <div class="mb-8">
                        ...
                        <h2 class="font-editorial text-3xl leading-tight sm:text-4xl">{{ $campaignTitle }}</h2>
                    ...
                    @if ($campaignAvailable)
                        ...
                        <div class="mb-8 rounded-[1.5rem] bg-[var(--surface-muted)] p-5">
                            <div class="mb-3 flex flex-col gap-2 text-sm font-semibold sm:flex-row sm:justify-between">
                        ...
                        <form method="POST" action="{{ route('donate.store') }}" class="grid gap-5 md:grid-cols-2">
                            ...
                            <div class="md:col-span-2">
                                <button class="w-full rounded-xl bg-[var(--primary)] px-8 py-4 text-sm font-semibold uppercase tracking-[0.14em] text-white sm:w-auto">
                                    Catat Niat Donasi
                                </button>
                            </div>
                        </form>
    ...
    <section class="bg-[var(--surface-muted)] py-20">
        <div class="mx-auto max-w-7xl px-6 lg:px-10">
            <div class="mb-12 flex flex-col items-start gap-6 sm:flex-row sm:items-end sm:justify-between sm:gap-8">
                <div>
                    <p class="section-label mb-4">{{ $page->sectionValue('documents.kicker', 'Dokumen') }}</p>
                    <h2 class="font-editorial text-4xl leading-tight lg:text-5xl">{{ $page->sectionValue('documents.title', 'Dokumen pendukung') }}</h2>
                </div>
